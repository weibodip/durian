...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by the {@code setDatabaseProperties} labeled alternative in {@link
   * SqlBaseParser#statement}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code insertOverwriteHiveDir} labeled alternative in {@link
   * SqlBaseParser#insertInto}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code valueExpressionDefault} labeled alternative in {@link
